...
uses
  DelphiCompat, Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs, Menus,
...
begin
 Q.FileObjectClassInfo(Info);
 Result:=(State=cmWindow) and (Info.PythonMacro=PythonMacro) and inherited AssignObject(Q, State);
end;
