...
{$ENDIF}
  ...
  AddOns in 'prog\AddOns.pas' {AddOnsAddDlg},
  ApplPaths in 'prog\ApplPaths.pas',
  ...
  Coordinates in 'prog\Coordinates.pas',
  ...
  TextBoxForm in 'prog\TextBoxForm.pas' {TextBoxForm},
