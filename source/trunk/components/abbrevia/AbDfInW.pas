...
type
  ...
  TAbDfInputWindow = class
    ...
    public
      ...
      function GetNextChar : ArithByte;
...
begin
  ...
  {otherwise check to see if we've seen at least FWinSize bytes}
    ...
    ByteCount := (CurPos - Integer(FWinSize)) - FStart;
    {$ELSE}
...
{--------}
function TAbDfInputWindow.GetNextChar : ArithByte;
begin
  Result := FCurrent^;
  inc(FCurrent);
end;
