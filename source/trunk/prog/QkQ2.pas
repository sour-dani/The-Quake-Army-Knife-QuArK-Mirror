...
uses
  SysUtils, Logging, qhelper, Travail, Quarkx, QkDaikatana, QkExceptions, QkQuakeCtx, QkText, Setup, QkObjectClassList;
...
begin
  ...
  begin
    ...
    if Header.Entries[I].Size = 0 then
    begin
      Log(LOG_WARNING, LoadStr1(5641), [FBsp.Name, Bsp2EntryNames[I]]);
    ...
    Q:=MakeFileQObject(F, Bsp2EntryNames[I], FBsp); //FIXME: Used Header.Entries[I].Size as third argument to OpenFileObjectData.
