...
uses StrUtils, Logging, Setup, Travail, Quarkx, QkExceptions, QkPixelSet,
...
begin
  ...
  begin
    ...
    if Header.Entries[I].Size = 0 then
    begin
      Log(LOG_WARNING, LoadStr1(5641), [FBsp.Name, BspSOFEntryNames[I]]);
    ...
    Q:=MakeFileQObject(F, BspSOFEntryNames[I], FBsp); //FIXME: Used Header.Entries[I].Size as third argument to OpenFileObjectData.
