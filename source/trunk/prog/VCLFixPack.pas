...
{$IF CompilerVersion < 20.0} // Delphi 6-2007
  ...
  //DanielPharos: Due to a bug in the VCL for older Delphi, some controls will not draw properly when enabling Common Controls V6.
  //More information: https://stackoverflow.com/questions/71173382/sometimes-common-controls-are-missing-from-the-form-run-time-tbutton-radio-ch
  // https://stackoverflow.com/questions/8358650/delphi-tedit-labels-are-not-displaying-windows-7-vista-only/43528855#43528855
  // https://stackoverflow.com/questions/3210890/exe-from-delphi-2006-buttons-checkbox-radios-not-visible-until-mouse-is-hovere
  // https://marc.durdin.net/2012/01/revisiting-the-vistaaltfixunit-pas-code/
  ...
  begin
    ...
    begin
      ...
      case Msg of
        ...
        {$IFDEF UpdateUIStateFix}
        WM_UPDATEUISTATE: //DanielPharos
          begin
            InvalidateRect(Handle, nil, False);
            Result := CallWindowProc(DefWndProc, Handle, Msg, WParam, LParam);
          end;
        {$ENDIF UpdateUIStateFix}
      else
