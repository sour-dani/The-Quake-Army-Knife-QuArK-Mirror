...
uses DelphiCompat, Windows, SysUtils, Classes, QkObjects, Qk3D, QkForm, Graphics,
...
begin
  if nSkin = FCurrentSkin then
    ...
    begin
      ...
      Result.Specifics.Insert(Result.Specifics.Count, Specifics.Items[Specifics.IndexOfName(SpecTris)]);
