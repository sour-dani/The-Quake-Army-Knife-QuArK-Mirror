...
#    Indent, Title                  ,Icon          ,URL
  ...
  ,array( 1,  "Main"                ,"news"        ,""                                                                )
  ,array( 2,    "News"              ,""            ,"index.php"                                                       )
  ,array( 3,      "Archive"         ,""            ,"archivednews.php"                                                )
...
# ,array( 3,      "Advanced"        ,""            ,"http://www.planetquake.com/quark/armin/advanced.html"            )
  ,array( 2,    "InstaPolls"        ,""            ,"instapolls.php"                                                  )
  ,array( 2,    "Credits"           ,""            ,"credits.php"                                                     )

  ,array( 1,  "QuArK"               ,"features"    ,""                                                                )
  ,array( 2,    "Features"          ,""            ,"features.php"                                                    )
  ,array( 2,    "Screenshots"       ,""            ,"features.php#screenshots"                                        )
  ,array( 2,    "Questions?"        ,""            ,"forums.php"                                                      )
  ,array( 2,    "Problems?"         ,""            ,"forums.php"                                                      )
  ,array( 2,    "Download"          ,""            ,"download.php"                                                    )
...
# ,array( 3,      "Glossary"        ,""            ,"http://www.planetquake.com/quark/help/glossary/index.html"       )
  ,array( 2,    "Download"          ,""            ,"download.php#help"                                               )

  ,array( 1,  "Community"           ,"community"   ,""                                                                )
  ,array( 2,    "Communication"     ,""            ,""                                                                )
  ,array( 3,      "Forums"          ,""            ,"forums.php"                                                      )
  ,array( 3,      "Mailing-lists"   ,""            ,"forums.php"                                                      )
  ,array( 3,      "IRC / Chat"      ,""            ,"forums.php"                                                      )
  ,array( 2,    "Misc. files"       ,""            ,""                                                                )
  ,array( 3,      "QuArK Addons"    ,""            ,"download_addons.php"                                             )
  ,array( 3,      "User Prefabs"    ,""            ,"userprefabs.php"                                                 )
  ,array( 3,      "User Maps"       ,""            ,"usermaps.php"                                                    )
# ,array( 3,      "Submit"          ,""            ,"usermaps_submit.php"                                             )
  ,array( 2,    "Help needed"       ,""            ,""                                                                )
  ,array( 3,      "Sugg. plug-ins"  ,""            ,"suggestedplugins.php"                                            )
# ,array( 3,      "Ad-Banners"      ,""            ,"adbanners.php"                                                   )
  ,array( 3,      "Ad-Buttons"      ,""            ,"adbuttons.php"                                                   )

  ,array( 1,  "Download"            ,"download"    ,""                                                                )
  ,array( 2,    "QuArK Addons"      ,""            ,"download_addons.php"                                             )
  ,array( 2,    "Python"            ,""            ,"download.php"                                                    )
  ,array( 2,    "QuArK"             ,""            ,"download.php"                                                    )
  ,array( 2,    "Online-help"       ,""            ,"download.php"                                                    )
# ,array( 2,    "Build-packs"       ,""            ,"download.php#buildpacks"                                         )
# ,array( 2,    "Add-ons v6.1"      ,""            ,"download.php#addons6"                                            )
# ,array( 2,    "Add-ons v5.10"     ,""            ,"download.php#addons"                                             )
# ,array( 2,    "Plug-ins"          ,""            ,"download.php#plugins"                                            )
# ,array( 2,    "Misc. Utils."      ,""            ,"download.php#misc"                                               )
...
# ,array( 2,    "Oldies"            ,""            ,"downloadoldies.php"                                              )
