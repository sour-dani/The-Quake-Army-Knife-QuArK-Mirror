...
$bodytext .= '<a rel="nofollow noopener" target="_blank" href="http://validator.w3.org/check?uri=referer">';
$bodytext .= DisplayImage('validhtml');
$bodytext .= '</a>';
...
$bodytext .= '<div class="mouseover">';
$bodytext .= '<a rel="nofollow noopener" target="_blank" href="http://jigsaw.w3.org/css-validator/check/referer">';
$bodytext .= DisplayImage('validcss');
$bodytext .= '</a>';
