...
#                                   |        |       |
$TutorialQuArK->Tutorials[] = new cTutorial('Creating a map', $infobaseroot.'maped.tutorial.html', NULL, 'This tutorial will guide you through the way the QuArK map-editor works, and how you should use it.'); #FIXME: Author: QuArK Development Team
...
#Non-official:
$TutorialQuArK->Tutorials[] = new cTutorial('Quake Army Knife editor tutorial for Quake 2', 'https://www.moddb.com/tutorials/quark-army-knife-editor-tutorial-for-quake-2', 144, 'How to use PakScape, configure the Quake Army Knife editor, saving your level and running/compiling it to a .bsp file, working with a .bsp file, opening the 3d window and navigating in 3d, editing the layout tab, WinBSP.'); #Also: https://quake2-dawn-of-darkness.blogspot.com/2015/09/quark-editor-tutorial-for-quake-2.html
$TutorialQuArK->Tutorials[] = new cTutorial('Adding and editing your Quake 2 engine based game mod with the editor Quake Army Knife', 'https://www.moddb.com/company/laika/tutorials/making-your-quake-2-engine-based-game-mod-with-the-editor-quark-army-knife', 144, 'This tutorial is made by my brother and me for those who want to understand better how to use the editor Quake Army Knife and modify her/his or an existing game mod.');
...
$TutorialQuArK->Tutorials[] = new cTutorial('Worldcraft to QuArK - Making the change', 'https://web.archive.org/web/20050523114750/http://scind.8m.com/Edit/wc2quark.html', 143);
$TutorialQuArK->Tutorials[] = new cTutorial('Become a level designer. Create your own map for True Combat.', 'https://www.tcmapping.com/', 141, NULL);
$TutorialQuArK->Tutorials[] = new cTutorial('Rizenet tutorials', 'https://web.archive.org/web/20020408142104/http://www.rizenet.com/games/quark/quark1/page1.php', 142, 'How-To Make Your Own Maps With Quark'); #http://www.rizenet.com/games/quark/page1.php
...
$TutorialOther->Tutorials[] = new cTutorial('69th Vlatitude Tutorials', 'https://web.archive.org/web/20090417185420/http://www.vlatitude.com/tutorials.php', NULL, NULL); #http://www.vlatitude.com/tutorials.php
...
$TutorialOther->Tutorials[] = new cTutorial('Rust tutorials', 'https://web.archive.org/web/20010607073854/http://www.gamedesign.net/tutorials', NULL, 'Here you will find tutorials that are general in nature and appeal to all QuakeX engine games..'); #http://www.gamedesign.net/tutorials
