...
$Companies['ACE Team'] = new cCompany('ACE Team', 'ACE Team', NULL, 'https://aceteam.cl/', 'https://en.wikipedia.org/wiki/ACE_Team');
...
//$Companies['Atlus'] = new cCompany('Atlus', 'Atlus Co., Ltd.', NULL, 'https://www.atlus.co.jp/', 'https://en.wikipedia.org/wiki/Atlus');
...
$Companies['Chaos Esque Team'] = new cCompany('Chaos Esque Team', 'Chaos Esque Team', NULL);
...
$Companies['FIX Korea'] = new cCompany('FIX Korea', 'FIX Korea', NULL);
...
$Companies['Hydra Game Works'] = new cCompany('Hydra Game Works', 'Hydra Game Works', NULL);
//$Companies['Hyperstrange'] = new cCompany('Hyperstrange', 'Hyperstrange S.A', NULL, 'https://hyperstrange.com/');
...
$Companies['Kepuli'] = new cCompany('Kepuli', 'Kepuli Games', NULL); #http://www.kepuli.com/force_leashed/
...
$Companies['Kot-in-Action'] = new cCompany('Kot-in-Action', 'Kot-in-Action Creative Artel', NULL, 'http://www.kot-in-action.com/', 'https://en.wikipedia.org/wiki/Kot-in-Action_Creative_Artel');
//$Companies['Kwalee'] = new cCompany('Kwalee', 'Kwalee', NULL);
...
//$Companies['Microsoft Studios'] = new cCompany('Microsoft Studios', 'Microsoft Studios', NULL, NULL, 'https://en.wikipedia.org/wiki/Microsoft_Studios');
...
//$Companies['Nuclearvision'] = new cCompany('Nuclearvision', 'Nuclearvision Entertainment GmbH', NULL);
$Companies['OGPlanet'] = new cCompany('OGPlanet', 'OGPlanet', NULL, NULL, 'https://en.wikipedia.org/wiki/OGPlanet'); #http://www.ogplanet.com/
...
//$Companies['Spicy Horse'] = new cCompany('Spicy Horse', 'Spicy Horse', NULL, NULL, 'https://en.wikipedia.org/wiki/Spicy_Horse'); //http://www.spicyhorse.com/
...
$Companies['STS'] = new cCompany('STS', 'Scientific Technical Solutions, Inc.', NULL); //Jean-Louis Clement #http://jlstsi.homestead.com/main.html
$Companies['Stunt Puppy Entertainment'] = new cCompany('Stunt Puppy Entertainment', 'Stunt Puppy Entertainment, Inc.', NULL);
...
$Companies['Tripwire'] = new cCompany('Tripwire', 'Tripwire Interactive', NULL, 'https://tripwireinteractive.com/', 'https://en.wikipedia.org/wiki/Tripwire_Interactive');
