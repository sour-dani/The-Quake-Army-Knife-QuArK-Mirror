...
class ToolMoveBar(qeditor.ToolBar):
    ...
    def buildbuttons(self, layout):
        ...
        if layout.MODE == SS_MAP:
            ...
            btn2.spec = "mpZoom"
            btn2.matrix = qeditor.matrix_zoom
            ...
            btn3.spec = "mpZoom"
            btn3.matrix = lambda f: qeditor.matrix_zoom(1.0/f)
            ...
            btn4.matrix = qeditor.matrix_sym('x')
            ...
            btn5.matrix = qeditor.matrix_sym('y')
            ...
            btn6.matrix = qeditor.matrix_sym('z')
            ...
            btn7.spec = "mpRotate"
            btn7.matrix = lambda f: qeditor.matrix_rot_x(f * qeditor.deg2rad)
            ...
            btn8.spec = "mpRotate"
            btn8.matrix = lambda f: qeditor.matrix_rot_x(-f * qeditor.deg2rad)
            ...
            btn9.spec = "mpRotate"
            btn9.matrix = lambda f: qeditor.matrix_rot_y(-f * qeditor.deg2rad)
            ...
            btn10.spec = "mpRotate"
            btn10.matrix = lambda f: qeditor.matrix_rot_y(f * qeditor.deg2rad)
            ...
            btn11.spec = "mpRotate"
            btn11.matrix = lambda f: qeditor.matrix_rot_z(-f * qeditor.deg2rad)
            ...
            btn12.spec = "mpRotate"
            btn12.matrix = lambda f: qeditor.matrix_rot_z(f * qeditor.deg2rad)
            ...
            mdlbtn2.spec = "mpZoom"
            mdlbtn2.matrix = qeditor.matrix_zoom
            ...
            mdlbtn3.spec = "mpZoom"
            mdlbtn3.matrix = lambda f: qeditor.matrix_zoom(1.0/f)
            ...
            mdlbtn4.matrix = qeditor.matrix_sym('x')
            ...
            mdlbtn5.matrix = qeditor.matrix_sym('y')
            ...
            mdlbtn6.matrix = qeditor.matrix_sym('z')
            ...
            mdlbtn7.matrix = lambda f: qeditor.matrix_rot_x(f * qeditor.deg2rad)
            ...
            mdlbtn8.matrix = lambda f: qeditor.matrix_rot_x(-f * qeditor.deg2rad)
            ...
            mdlbtn9.matrix = lambda f: qeditor.matrix_rot_y(-f * qeditor.deg2rad)
            ...
            mdlbtn10.matrix = lambda f: qeditor.matrix_rot_y(f * qeditor.deg2rad)
            ...
            mdlbtn11.matrix = lambda f: qeditor.matrix_rot_z(-f * qeditor.deg2rad)
            ...
            mdlbtn12.matrix = lambda f: qeditor.matrix_rot_z(f * qeditor.deg2rad)
