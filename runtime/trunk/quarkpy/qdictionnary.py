...
#   176: "// This map has been written by QuArK - Quake Army Knife, %s\n// It is a map for the game %s.\n\n// It is recommended that you compile this map using TXQBSP, a version of QBSP\n// that can process floating-point coordinates and enhanced texture positioning.\n// For more information see QuArK's Home Page :  https://quark.sourceforge.io//\n\n",
    ...
    5219: "The file '%s' cannot be saved, because saving of %s is currently not supported. File ignored.",
    ...
    5503: "'%s' is a %s Model file that cannot be loaded (yet)",
    ...
    5572: "'%s' is a %s BSP file with an unknown version//Version %d",
    ...
    5593: "'%s' is not a supported MDL file//Signature %d",
    ...
    5602: "'%s' is a %s BSP file that cannot be loaded (yet)",
    ...
    5613: "Failed to delete the Registry association for '.%s'.//%s",
    ...
    # 5615: "\t.%s\t(%s)\n",
    5616: "Failed to create the Registry association for '.%s'.//%s",
    ...
    5807: "The file '%s' cannot be loaded, because loading of %s is currently not supported.",
    ...
    5844: "Could not write to extension key.",
    #5845: "Could not create class Registry key.",
    #5846: "Could not create command open Registry key.",
    5847: "Now attempting to register file association for '.%s'...",
    5848: "Could not open extension key.",
    5849: "Could not open file-class key.",
    5850: "Could not open file-class command key.",
    ...
    5861: "Unable to set '%s' for file extension '.%s'//Key: '%s'",
    5862: "%s (empty)",
    ...
    5877: "QuArK Notification",
    5878: "There are new update notifications:",
    5879: "The online update check has failed with the following error: %s\n\nIf this error persists, please contact the QuArK development team.",
    5880: "Unable to check for updates online! Using offline update routine.",
    5881: "No updates were found.",
    5882: "Offline update: Old version of QuArK detected!",
    5883: "This version of QuArK is rather old. Do you want to open the QuArK website to check for updates?",
    5884: "Unable to open website! Please manually go to: %s",
    5885: "No updates were found.",
    5886: "No packages selected. Please first select packages to install, or click 'Cancel'.",
    5887: "Description",
    ...
    6013: "Unable to access Desktop Window Manager (DWM).//Desktop Composition may be enabled, causing corruption in OpenGL and Direct3D viewports",
