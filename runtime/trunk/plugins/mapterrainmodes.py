...
class TerrModesBar(ToolBar):
    ...
    def buildbuttons(self, layout):
        ...
        for i in range(len(TerrModes)):
            ...
            btn = quarkpy.qtoolbar.button(selectmode, obj.Hint, ico_dict['ico_terrmodes'], icon)
            btn.i = i
            btns.append(btn)
